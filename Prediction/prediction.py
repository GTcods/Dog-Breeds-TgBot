...
def predict_breed(model, img_array, version):
    global class_names
    match version:
        case 1:
...
class_names1 = ['Afghan Hound', 'Doberman Pinscher']

class_names2 = ['Beagle', 'Bulldog', 'Dachshund', 'Doberman Pinscher', 'French Bulldog', 'German Shepherd',
                'Golden Retriever', 'Labrador Retriever', 'Poodle', 'Siberian Husky']

class_names3 = ['Affenpinscher', 'Afghan Hound', 'Airedale Terrier', 'Akita', 'Alaskan Malamute', 'American Bulldog',
